...
<html lang="en">
    ...
    <body>
        ...
        <?php
        if ($_COOKIE['display_cookie'] != 'on') {
        setcookie("display_cookie","on", time()+3600*24*395);
        ?>
        <div id="cookies_module">
            <p>
                <span class="hidden_module">En poursuivant votre navigation sur ce site, vous acceptez <a href="https://sensorium.immo/politique-cookies.php?utm_campaign=sensorium&utm_medium=direct&utm_source=direct" target="_blank">
                nos conditions générales d’utilisation</a> et notamment que des cookies soient utilisés afin d’améliorer votre expérience d’utilisateur et 
                de vous offrir des contenus personnalisés. Vous êtes par ailleurs informés que nous mettons en oeuvre un système de détection des bloqueurs de publicité sur ce site. 
                En savoir plus et <a href="https://www.cnil.fr/fr/cookies-les-outils-pour-les-maitriser" target="_blank">paramétrer les cookies.</a></span>
            </p>
            <button type="button" id="btn_close_cookie_module" onclick="javascript: document.getElementById('cookies_module').style.display='none';"> J'ai compris </button>
        </div>
        <?php } ?>
